...
import com.test.libros.servicio.CategoriasFacade;
...
public class CategoriasController implements Serializable {
    ...
    @EJB
    private com.test.libros.servicio.CategoriasFacade ejbFacade;
    ...
    public Categorias getCategorias(java.math.BigDecimal id) {
